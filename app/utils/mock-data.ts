...
const baseCustomers: Customer[] = [
  {
    ...
    tags: ['都市銀行', '法人営業', 'VIP'],
    contacts: [
      { id: 'cont_001', type: 'email', value: 'contact@sample-bank.jp', name: '田中太郎', isPrimary: true },
  ...
  },
  {
    ...
    tags: ['信用金庫', '地域金融', '新規'],
    contacts: [
      { id: 'cont_003', type: 'email', value: 'info@test-shinkin.jp', name: '鈴木花子', isPrimary: true },
      { id: 'cont_006', type: 'phone', value: '03-9876-5432', isPrimary: false }
    ],
    assignedSalesStaff: ['user_003'],
    notes: '定期的な調達あり。地域密着型の信用金庫。',
  ...
  },
  {
    ...
    code: 'C003',
    name: 'ダミーファイナンス銀行',
    furigana: 'だみーふぁいなんすぎんこう',
    tags: ['都市銀行', '資産運用', 'VIP'],
    contacts: [
      { id: 'cont_004', type: 'fax', value: '06-5678-9012', name: '佐藤次郎', isPrimary: true },
      { id: 'cont_005', type: 'email', value: 'procurement@dummy-finance.jp', isPrimary: false }
    ],
  ...
  },
  {
    ...
    code: 'C004',
    name: '仮想第一銀行',
    furigana: 'かそうだいいちぎんこう',
    tags: ['地方銀行', '融資'],
    contacts: [
      { id: 'cont_007', type: 'email', value: 'sales@kasou-bank.jp', name: '高橋一郎', isPrimary: true }
    ],
    assignedSalesStaff: ['user_002'],
    notes: '地方銀行大手。融資案件の実績あり。',
  ...
  },
  {
    ...
    tags: ['信託銀行', '資産管理'],
    contacts: [
      { id: 'cont_008', type: 'email', value: 'info@mock-asset.jp', name: '伊藤美咲', isPrimary: true },
      { id: 'cont_009', type: 'fax', value: '011-234-5678', isPrimary: false }
    ],
    assignedSalesStaff: ['user_003', 'user_004'],
    notes: '信託・資産管理サービスの定期契約あり。',
  ...
  },
  {
    ...
    code: 'C006',
    name: '開発信用銀行',
    furigana: 'かいはつしんようぎんこう',
    tags: ['信用銀行', '開発融資', 'VIP'],
    contacts: [
      { id: 'cont_010', type: 'email', value: 'contact@kaihatsu-credit.jp', name: '渡辺健太', isPrimary: true },
      { id: 'cont_011', type: 'phone', value: '06-1111-2222', isPrimary: false }
    ],
    assignedSalesStaff: ['user_001'],
    notes: '開発融資専門。年間契約更新済み。',
  ...
  },
  {
    ...
    tags: ['データバンク', '情報サービス'],
    contacts: [
      { id: 'cont_012', type: 'email', value: 'info@test-databank.jp', name: '山田浩司', isPrimary: true }
    ],
    assignedSalesStaff: ['user_002', 'user_003'],
    notes: '金融情報サービス。データ品質基準が非常に厳しい。',
  ...
  },
  {
    ...
    code: 'C008',
    name: 'ダミー中央銀行',
    furigana: 'だみーちゅうおうぎんこう',
    tags: ['中央銀行', '国際金融', '新規'],
    contacts: [
      { id: 'cont_013', type: 'email', value: 'procurement@dummy-central.jp', name: '中村さゆり', isPrimary: true },
      { id: 'cont_014', type: 'phone', value: '03-5555-6666', isPrimary: false }
    ],
    assignedSalesStaff: ['user_004'],
    notes: '国際金融取引対応。新規取引開始。',
  ...
  },
  {
    ...
    code: 'C009',
    name: '開発ファイナンス銀行',
    furigana: 'かいはつふぁいなんすぎんこう',
    tags: ['開発金融', 'プロジェクト融資'],
    contacts: [
      { id: 'cont_015', type: 'email', value: 'sales@kaihatsu-finance.jp', name: '小林誠', isPrimary: true }
    ],
    assignedSalesStaff: ['user_001'],
    notes: 'プロジェクトファイナンス専門。開発融資対応。',
  ...
  },
  {
    ...
    tags: ['ネット銀行', 'リテール'],
    contacts: [
      { id: 'cont_016', type: 'email', value: 'info@test-bank.jp', name: '松本幸子', isPrimary: true },
      { id: 'cont_017', type: 'fax', value: '045-333-4444', isPrimary: false }
    ],
    assignedSalesStaff: ['user_002', 'user_004'],
    notes: 'ネット銀行。リテール向けサービスが主力。',
...
export const mockActivities: SalesActivity[] = [
  {
    id: 'act_001', code: 'SA2026-001', customerId: 'cust_001', customerName: 'サンプル銀行',
  ...
  {
    id: 'act_002', code: 'SA2026-002', customerId: 'cust_002', customerName: 'テスト信用金庫',
  ...
  {
    id: 'act_003', code: 'SA2026-003', customerId: 'cust_003', customerName: 'ダミーファイナンス銀行',
  ...
  {
    id: 'act_004', code: 'SA2026-004', customerId: 'cust_001', customerName: 'サンプル銀行',
  ...
  {
    id: 'act_005', code: 'SA2026-005', customerId: 'cust_004', customerName: '仮想第一銀行',
  ...
  {
    id: 'act_006', code: 'SA2026-006', customerId: 'cust_005', customerName: 'モック資産銀行',
...
function generateHistoricalRecords(): HistoricalRecord[] {
  ...
  const customers = [
    { id: 'cust_001', name: 'サンプル銀行', code: '00611' },
    { id: 'cust_002', name: 'テスト信用金庫', code: '00705' },
    { id: 'cust_003', name: 'ダミーファイナンス銀行', code: '00812' }
  ]
...
export function generateDailyReport(date: string, groupBy: 'salesperson' | 'customer'): DailyReport {
  const entries: DailyReportEntry[] = [
    { activityId: 'act_001', activityCode: 'SA2026-001', customerName: 'サンプル銀行', assignedToName: '加藤 誠', type: 'visit', title: '総代会記念品ヒアリング', description: '予算400万円、4000個の見込み。食品・菓子系を中心に提案希望。', activityDate: date },
    { activityId: 'act_003', activityCode: 'SA2026-003', customerName: 'ダミーファイナンス銀行', assignedToName: '加藤 誠', type: 'visit', title: '夏季ギフト打ち合わせ', description: 'お中元期間の社員向けギフト提案。カタログギフト中心で検討中。', activityDate: date },
    { activityId: 'act_004', activityCode: 'SA2026-004', customerName: 'サンプル銀行', assignedToName: '加藤 誠', type: 'email', title: 'サンプル送付の連絡', description: '記念品候補のサンプル3点を送付した旨をメールで連絡。', activityDate: date },
    { activityId: 'act_002', activityCode: 'SA2026-002', customerName: 'テスト信用金庫', assignedToName: '鈴木 花子', type: 'phone', title: '新入社員研修用品の確認電話', description: '研修用品のニーズを電話でヒアリング。トートバッグ50枚程度。', activityDate: date },
    { activityId: 'act_005', activityCode: 'SA2026-005', customerName: '仮想第一銀行', assignedToName: '鈴木 花子', type: 'meeting', title: '防災用品提案ミーティング', description: '防災グッズのまとめ発注について提案予定。', activityDate: date }
  ]
